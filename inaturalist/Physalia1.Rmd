...
geom_polygon(data = mapWorld, aes(x = long, y = lat, group = group), fill = "light gray") +
geom_point(data = all_results, aes(x = longitude, y = latitude, size = as.numeric(crest_height)), alpha = 0.5, pch = 16) +
theme(axis.text.x = element_blank(), axis.text.y = element_blank()) +
...
geom_polygon(data = mapWorld, aes(x = long, y = lat, group = group), fill = "light gray") +
geom_point(data = all_results, aes(x = longitude, y = latitude, size = as.numeric(thumb_ratio)), alpha = 0.5, pch = 16) +
theme(axis.text.x = element_blank(), axis.text.y = element_blank()) +
