...
all_checked <- bind_rows(
	physalis_checked %>% mutate(assignment = "A"),
	utriculus_checked %>% mutate(assignment = "B1"),
	megalista_checked %>% mutate(assignment = "C1"),
	C2_checked %>% mutate(assignment = "C2"))

write.table(all_checked,file="../data/inaturalist_assignments.tsv",row.names=F,quote=T,sep="\t")
```
